...
'''
File: coral_with_data.py
Date: 109/12/02(Wed)
VERSION: 1.0
Author : Chun

INFO:
Modify Original Code to Save and Reload Data.

Modify Items:
1. Modify __init__ .
2. Add Function: Check Dir, Clear Dir, Reload Data.
3. Modify classify : Clear DataFolder & Save data to target folder.
'''
